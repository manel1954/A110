...
#/home/pi/A110/./qt_info_solodstar & sudo ircddbgateway -gui & sudo ./MMDVMDSTAR MMDVMDSTAR.ini
...
sed -i "7c Icon=/home/pi/$SCRIPTS_version/SOLO_ICO_SOLODSTAR_OFF.png" /home/pi/Abrir_solodstar.desktop
